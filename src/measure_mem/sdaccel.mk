...
krnl_SRCS   =krnl.cl
krnl_HDRS   = 
krnl_CFLAGS = -g --memory_port_data_width all:512 --max_memory_ports load_data --sp load_data_1.m_axi_gmem0:bank1
krnl_LFLAGS = --max_memory_ports load_data --sp load_data_1.m_axi_gmem0:bank1
